...
function run(overrides: Partial<KnowledgeRun> = {}): KnowledgeRun {
  return {
    ...
    pages_considered: 3,
    // R05: the page account travels on the run, so a fixture cannot describe a
    // run without saying what it was a run over.
    coverage: {
      pages_total: 4,
      pages_offered: 3,
      pages_processed: 3,
      ...
      notes: ['страница ждёт распознавания: текстового слоя нет: 1 стр. (4)'],
      requirements: 'met',
...
function overview(overrides: Partial<KnowledgeOverview> = {}): KnowledgeOverview {
  return {
    ...
    summary: {
      ...
      uncertainties_total: 1,
      passports_substantive: 1,
      materials_ready: 1,
      questions_total: 1,
