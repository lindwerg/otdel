...
help:
	...
	@echo "    make worker       - run the worker: extraction + understanding + research + maintenance"
	@echo "    make worker-once  - one pass of each, then exit"
	@echo "    make worker-probe - report OCR, model and research adapter availability"
