...
/** Sections of the partner card that exist today. Knowledge is phase 1C; versions
 *  and history arrive with 1E/1F and are deliberately absent rather than stubbed. */
const TABS = [
